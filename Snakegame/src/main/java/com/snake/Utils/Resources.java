...
public class Resources
{
    ...
    public static void playSoundByName(String name, double volume, boolean loop)
    {
    ...
    public static void playSoundByName(String name, double volume)
    {
        playSoundByName(name, volume, false);
    }
}
